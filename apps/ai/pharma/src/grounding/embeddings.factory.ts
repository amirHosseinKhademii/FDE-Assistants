/**
 * WHERE PHARMA'S EMBEDDING CLIENT COMES FROM. That is all that is left here.
 *
 * ── WHAT THIS FILE USED TO BE ────────────────────────────────────────────
 *
 * Forty lines, byte-identical to `packages/insurance/src/grounding/
 * embeddings.factory.ts` apart from one import path, carrying its own note:
