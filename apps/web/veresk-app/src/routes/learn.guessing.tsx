/** `/learn/guessing` — an engagement lesson. Its number and title live in `lib/learn/lessons.ts`. */
import { createFileRoute } from '@tanstack/react-router';
import { Guessing } from '../pages/learn/Guessing';
import { lessonBySlug } from '../lib/learn/lessons';

const lesson = lessonBySlug('guessing');

export const Route = createFileRoute('/learn/guessing')({
