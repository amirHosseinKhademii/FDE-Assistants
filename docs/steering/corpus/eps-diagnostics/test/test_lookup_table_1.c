/*
 * test_lookup_table_1.c — unit tests for SWC-PLT-025
 *
...
void test_LookupTable_Get_is_monotonic(void)
{
...
void test_LookupTable_Apply_is_monotonic(void)
{
    LookupTable1In_t  in  = { 0 };
    LookupTable1Out_t out = { 0 };
...
void test_LookupTable_Update_rejects_null(void)
{
    TEST_ASSERT_EQUAL(E_NOT_OK, LookupTable_Update(NULL_PTR, NULL_PTR));
}

void test_LookupTable_Update_saturates_at_limit(void)
{
    LookupTable1In_t  in  = { 0 };
    LookupTable1Out_t out = { 0 };
    TEST_ASSERT_EQUAL(E_OK, LookupTable_Update(&in, &out));
    TEST_ASSERT_FLOAT_WITHIN(0.001f, 0.0f, out.out);
}
...
void test_LookupTable_Check_saturates_at_limit(void)
{
    LookupTable1In_t  in  = { 0 };
    LookupTable1Out_t out = { 0 };
