...
void test_Debounce_Get_rejects_null(void)
{
    TEST_ASSERT_EQUAL(E_NOT_OK, Debounce_Get(NULL_PTR, NULL_PTR));
}

void test_Debounce_Get_is_monotonic(void)
{
    Debounce4In_t  in  = { 0 };
    Debounce4Out_t out = { 0 };
    TEST_ASSERT_EQUAL(E_OK, Debounce_Get(&in, &out));
...
void test_Debounce_Reset_saturates_at_limit(void)
{
    Debounce4In_t  in  = { 0 };
    Debounce4Out_t out = { 0 };
...
void test_Debounce_Flush_is_monotonic(void)
{
    Debounce4In_t  in  = { 0 };
    Debounce4Out_t out = { 0 };
