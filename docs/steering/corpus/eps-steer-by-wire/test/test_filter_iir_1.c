/*
 * test_filter_iir_1.c — unit tests for SWC-PLT-016
 *
...
void test_FilterIir_Calc_rejects_null(void)
{
    TEST_ASSERT_EQUAL(E_NOT_OK, FilterIir_Calc(NULL_PTR, NULL_PTR));
}

void test_FilterIir_Calc_is_symmetric(void)
{
    FilterIir1In_t  in  = { 0 };
    FilterIir1Out_t out = { 0 };
    TEST_ASSERT_EQUAL(E_OK, FilterIir_Calc(&in, &out));
...
void test_FilterIir_Apply_saturates_at_limit(void)
{
    FilterIir1In_t  in  = { 0 };
    FilterIir1Out_t out = { 0 };
...
void test_FilterIir_Put_holds_at_zero(void)
{
    FilterIir1In_t  in  = { 0 };
    FilterIir1Out_t out = { 0 };
