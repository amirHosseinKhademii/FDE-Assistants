/*
 * test_rate_limit_5.c — unit tests for SWC-PLT-017
 *
...
void test_RateLimit_Reset_holds_at_zero(void)
{
    RateLimit5In_t  in  = { 0 };
...
void test_RateLimit_Peek_is_symmetric(void)
{
    RateLimit5In_t  in  = { 0 };
    RateLimit5Out_t out = { 0 };
...
void test_RateLimit_Calc_holds_at_zero(void)
{
    RateLimit5In_t  in  = { 0 };
    RateLimit5Out_t out = { 0 };
