/*
 * test_rate_limit_6.c — unit tests for SWC-PLT-001
 *
...
void test_RateLimit_Update_saturates_at_limit(void)
{
    RateLimit6In_t  in  = { 0 };
    RateLimit6Out_t out = { 0 };
...
void test_RateLimit_Reset_is_symmetric(void)
{
    RateLimit6In_t  in  = { 0 };
    RateLimit6Out_t out = { 0 };
