# SOP-QC-014 Rev 6 — Batch Release and QP Certification

> Revision Id: SOP-QC-014 Rev 6 · SOP Id: SOP-QC-014 · Revision: 6 · Status: superseded · Effective: 2023-07-01 · Expires: 2026-02-28 · Owner: DEPT-QA · Category: quality · Implements: ANNEX16-1.5, CFR-211.165, CFR-211.22
...
**Added at this revision.** QA confirms that every deviation raised against the
work order has been closed, or, where a deviation remains open, that its
assessment concludes the batch is not affected. The reconciliation is recorded
on the disposition record naming each deviation by identifier.
...
certifying Qualified Person and the date of certification. The record is
retained for one year beyond the expiry of the batch, and in no case less than
five years.
...
| 6 | 2023-07-01 | Added §6.2, reconciliation of the batch record against the deviation log, before certification. |
