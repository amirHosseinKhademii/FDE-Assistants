...
Amounts below are the standard offering for form PP 00 03 06 24. **The Declarations
page for an individual policyholder controls where it differs.**

| Coverage | Limit | Deductible |
|---|---|---|
| Collision | Actual cash value | $1,500 |
| Comprehensive | Actual cash value | $1,000 |
| Rental Reimbursement | $25 per day, 15 days max | None |
| Bodily Injury Liability | $50,000 / $100,000 | None |
...
Under form PP 00 03 06 24 we will pay **$25 per day, for a maximum of
...
actual cash value for a total loss, or the day the 15-day maximum
is reached.
...
## Part V — Essential Program Restrictions

### 5.1 Essential Program Restrictions

**Rental Reimbursement is OPTIONAL on this form** and applies only where it is
