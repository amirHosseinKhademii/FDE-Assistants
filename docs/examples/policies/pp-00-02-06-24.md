...
Amounts below are the standard offering for form PP 00 02 06 24. **The Declarations
...
| Rental Reimbursement | $60 per day, 45 days max | None |
| Bodily Injury Liability | $250,000 / $500,000 | None |
| Property Damage Liability | $100,000 | None |
...
Under form PP 00 02 06 24 we will pay **$60 per day, for a maximum of
45 days** per occurrence.
...
actual cash value for a total loss, or the day the 45-day maximum
is reached.
...
## Part V — Preferred Program Benefits

### 5.1 Preferred Program Benefits

**Deductible waiver.** The Collision deductible is waived where the loss is
