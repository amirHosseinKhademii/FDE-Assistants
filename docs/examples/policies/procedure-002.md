# PRC-002 — Claims Handling Procedures: Establishing the Governing Documents

> Meridian Mutual Insurance Company. Fictional document, written for an FDE
> practice engagement. Do not use for anything real.
>
> Document: PRC-002 · Type: procedure · Jurisdiction: National
> Effective: 2023-02-01 · Status: current · Revision: 4
> Owner: Claims Practices
> Applies to: PP 00 01 06 24, PP 01 50 06 24, PP 01 06 06 24, PP 01 79 06 24, PP 01 20 06 24

## 0. About This Document

Recording which form edition and which endorsements govern, before any coverage position is taken. It tells an adjuster how to act.
