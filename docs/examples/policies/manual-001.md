# UWM-001 — Personal Auto Underwriting Manual: Eligibility and Acceptable Risks

> Meridian Mutual Insurance Company. Fictional document, written for an FDE
> practice engagement. Do not use for anything real.
>
> Document: UWM-001 · Type: manual · Jurisdiction: National
...
This manual covers eligibility and acceptable risks for the personal auto program.
