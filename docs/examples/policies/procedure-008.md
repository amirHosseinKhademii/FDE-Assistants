# PRC-008 — Claims Handling Procedures: Denial, Partial Denial and Escalation

> Meridian Mutual Insurance Company. Fictional document, written for an FDE
> practice engagement. Do not use for anything real.
>
> Document: PRC-008 · Type: procedure · Jurisdiction: National
...
Communicating an adverse decision and referring what an adjuster may not decide. It tells an adjuster how to act.
