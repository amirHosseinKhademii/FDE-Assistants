# UWM-003 — Personal Auto Underwriting Manual: Coverages Offered, Discounts and Surcharges

> Meridian Mutual Insurance Company. Fictional document, written for an FDE
> practice engagement. Do not use for anything real.
>
> Document: UWM-003 · Type: manual · Jurisdiction: National
> Effective: 2023-01-01 · Status: current · Revision: 3
> Owner: Underwriting
> Applies to: PP 00 01 06 24, PP 01 50 06 24, PP 01 06 06 24, PP 01 79 06 24, PP 01 20 06 24

## 1. How to Use This Manual

This manual covers coverages offered, discounts and surcharges for the personal auto program.
